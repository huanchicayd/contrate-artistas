            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="section-title__primary section-title__primary--flex resultado-busca__title">
                        <h2 class="section-title__title">Show</h2>
                        <span class="section-title__search-status"><strong>302821</strong> atrações artísticas</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <aside class="sidebar" data-js="sidebar">
                        ...
                        <div class="sidebar-categorias">
                            ...
                            <form class="" action="index.html" method="post">
                                ...
                                <!-- Esse pedaço só aparece depois que o usuário filtra as categorias -->
                                <!-- <div class="sidebar-subcategorias">
                                    <div class="sidebar-categorias__checkbox">
                                        <input type="checkbox" name="" value="false" id="check-subcategoria01" class="styled-checkbox">
                                        <label for="check-subcategoria01">Subcategoria01</label>
                                    </div>
                                    <div class="sidebar-categorias__checkbox">
                                        <input type="checkbox" name="" value="false" id="check-subcategoria02" class="styled-checkbox">
                                        <label for="check-subcategoria02">Subcategoria02</label>
                                    </div>
                                </div> -->
