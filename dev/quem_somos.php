...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p class="quem-somos__sobre__text">
    ...
    <section class="quem-somos__destaque">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-12">
                            <h2 class="chamada-destaque__text">
                                Frase de impacto que resume a missão da Contrate para os públicos!
                            </h2>
                        </div>
                    </div>
                </div>
    ...
    <section class="quem-somos__resultados">
        <div class="container">
            <div class="row">
                <div class="col-xl-3">
                    <h4 class="quem-somos__numbers">148.846</h4>
                    <p class="quem-somos__text">artistas cadastrados</p>
                </div>
                <div class="col-xl-3">
                    <h4 class="quem-somos__numbers">105.846</h4>
                    <p class="quem-somos__text">curtidas</p>
                </div>
                <div class="col-xl-3">
                    <h4 class="quem-somos__numbers">5.846</h4>
                    <p class="quem-somos__text">eventos realizados</p>
                </div>
                <div class="col-xl-3">
                    <h4 class="quem-somos__numbers">2.846</h4>
                    <p class="quem-somos__text">clientes satisfeitos</p>
                </div>
            </div>
        </div>
    </section>
