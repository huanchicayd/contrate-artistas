      ...
      <div class="row">
        ...
        <div class="col-lg-10 footer-news__cadastro">
          ...
          <form class="footer-news__form" action="index.html" method="post">
            ...
            <button type="button" name="button" class="footer-news__form-btn">Cadastrar</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 footer-about">
          <p><strong>A Contrate Artistas é a escolha mais confiável para aqueles que visam qualidade, segurança e diversas opções na hora de contratar atrações artísticas para seus eventos especiais, sem pagar nada a mais por isso.</strong>
          </p>
          <p>
