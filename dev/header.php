...
<html>
  ...
  <body>
    <header class="header" data-js="navbar">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 header-brand">
            <button type="button" name="button" class="header-menu-btn" data-js="header-menu-btn">
              <span></span>
            </button>
            <a href="#">
          ...
          <div class="col-lg-5 header-search" data-js="header-search">
            <form action="" class="header-search__form">
              <input type="search" class="header-search__input" placeholder="Qual atração artística está buscando?">
              <button class="header-search__btn"></button>
            </form>
          </div>
          <div class="col-lg-3 header-info">
            <p class="header-info__atendimento">Atendemos todo o Brasil, de 2a 6a feira, das 8h às 17h</p>
            <p class="header-info__telefones">(21) 3049-4910 / (21) 98616-7897</p>
          </div>
          <div class="header-menu-wrap" data-js="header-menu">
